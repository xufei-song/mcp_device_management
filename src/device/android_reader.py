...
def read_android_devices():
    ...
    try:
        ...
        csv_file_path = current_dir / "Devices" / "android_devices.csv"
        
        # 检查文件是否存在
        if not csv_file_path.exists():
            raise FileNotFoundError(f"Android设备CSV文件未找到: {csv_file_path}")
